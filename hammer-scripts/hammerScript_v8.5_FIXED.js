// =====================================================================
// HAMMER v8.5 "FIXED EDITION"
// Fixed: autogold tab clickable, removed scroll views, kept v8.3 structure
// =====================================================================
(() => {
  // Hard reset
  ...
  ui.innerHTML = `
    <div id="hm-head" style="display:flex;align-items:center;justify-content:space-between;padding:8px 10px;background:#151f33;border-bottom:1px solid #86531f;cursor:move;flex-shrink:0">
      <div><b>HAMMER v8.5</b> <span style="opacity:.85">Fixed</span></div>
  ...
  window.__HAMMER__ = { cleanup, ui: { root: ui }, version: '8.5' }

  render()
  console.log('%c[HAMMER]%c v8.5 FIXED ready! 🔨', 'color:#deb887;font-weight:bold', 'color:inherit')
  console.log('[HAMMER] ✅ Fixed: autogold tab clickable, removed scroll limits!')
})()
