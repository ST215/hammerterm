// =====================================================================
// HAMMER v9.0 "APEX" — The Ultimate Edition
// FIXED: Auto-gold performance (now as snappy as auto-troops)
// FIXED: Auto-gold target selection now working properly
// FIXED: Number formatting bugs (150k no longer shows as 1.5M)
// FIXED: Multi-feed calculations (no more infinity bugs)
// FIXED: Nested scroll bounce issues removed
// FIXED: Excessive refresh rates in Command View and Threat displays
// REMOVED: Battle Predictor (replaced with Weak Player Identification)
// REMOVED: Alliance Coordinator (team doesn't use it)
// ENHANCED: Gold Rate intelligence and analysis
// ENHANCED: Feed rate calculations with game knowledge
// ENHANCED: Automation tab links to dedicated screens
// NEW: Weak Player Targeting system
// =====================================================================
(() => {
