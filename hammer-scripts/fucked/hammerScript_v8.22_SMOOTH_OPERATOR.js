// =====================================================================
// HAMMER v8.22 "SMOOTH OPERATOR" — Performance Edition
// FIXED: Large team scroll performance (40-50+ players)
// FIXED: Auto-donate troops target list now uses pagination (15 per page)
// FIXED: Auto-donate gold target list now uses pagination (15 per page)
// ENHANCED: Eliminated DOM bloat from rendering all targets at once
// ENHANCED: Smooth scrolling and navigation with prev/next buttons
...
(() => {
  ...
  const tabs = ['command', 'summary', 'stats', 'aiinsights', 'threat', 'power', 'ports', 'feed', 'goldrate', 'alliances', 'autotroops', 'autogold', 'overlays', 'embargo', 'hotkeys']
  const tabLabels = {
    command: 'Command',
  ...
  window.__HAMMER__ = { cleanup, ui: { root: ui }, version: '8.22' }
  ...
  console.log('%c[HAMMER]%c v8.22 SMOOTH OPERATOR ready! 🔨', 'color:#deb887;font-weight:bold', 'color:inherit')
  console.log('[HAMMER] Status:', initMessages.join(' | '))
  console.log('[HAMMER] ✅ Large team pagination (15 players per page)!')
  console.log('[HAMMER] ✅ Performance optimized for 40-50+ teammates!')
